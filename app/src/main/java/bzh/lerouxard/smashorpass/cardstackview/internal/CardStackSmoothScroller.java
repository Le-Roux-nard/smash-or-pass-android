...
import bzh.lerouxard.smashorpass.cardstackview.RewindAnimationSetting;
...
public class CardStackSmoothScroller extends RecyclerView.SmoothScroller {
    ...
    protected void onSeekTargetStep(
        ...
        if (type == ScrollType.AutomaticRewind) {
            ...
            action.update(
                    -getDx((AnimationSetting) setting),
                    -getDy((AnimationSetting) setting),
                    setting.getDuration(),
    ...
    protected void onTargetFound(
        ...
        switch (type) {
            case AutomaticSwipe:
                setting = (AnimationSetting) manager.getCardStackSetting().swipeAnimationSetting;
                action.update(
                        -getDx(setting),
                        -getDy(setting),
                        setting.getDuration(),
            ...
            case AutomaticRewind:
                setting = (AnimationSetting) manager.getCardStackSetting().rewindAnimationSetting;
                action.update(
                        x,
                        y,
                        setting.getDuration(),
